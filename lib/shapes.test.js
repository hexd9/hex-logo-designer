...
describe("Triangle", () => {
  it("Should display a triangle with selected background color", () => {
    ...
    const logoResult = `<svg width="500" height="300" version="1.1" xmlns="http://www.w3.org/2000/svg"><polygon points="250,60 100,400 400,400" class="triangle" fill="${shapeColor}"/><text font-size="30px" x="250" y="220" fill="${textColor}">${text}</text></svg>`;
